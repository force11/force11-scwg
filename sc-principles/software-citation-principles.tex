...
\newcommand{\flnote}[1]{ {\textcolor{olive} { ***FL: #1 }}} %Frank Lšffler
...
The principles in this section are written fairly concisely, and discussed further later in this document (\S\ref{sec:discussion}). For example, in this section we do not define what software should be cited, but how it should be cited.  we talk about how we think such decisions might be made in the discussion section.
...
\midrule
Cite to publication     & 105 & 37\% \\ % & \ldots was calculated using biosys (Swofford \& Selander 1981). \newline Ref: Swofford DL, Selander RB (1981) biosys-1: a Fortran program for the comprehensive analyses of electrophoretic data in population genetics and systematics. \emph{Journal of Heredity}, 72, 281â€“283. \\
...
In the principles, we did not define what software should be cited, but how it should be cited.
...
We suggest that if Excel is used to simply store and plot data, it does not need to be cited, but if it is used for statistical analysis, it should be.
...
\scnote{\emph{Do not cite standard office software (e.g. Word, Excel) or programming languages.  Provide references only for specialized software. }---Source: \url{https://owl.english.purdue.edu/owl/resource/560/10/}. Likewise,  on what software not to cite,  generally speaking, we should not cite general software for conducting library research (e.g., JSTOR Mobile App), writing research papers (e.g., \LaTeX), scientific presentations (e.g., Powerpoint) or communications (e.g. Skype).}
...
\textbf{Unique identifiers}

A UID points to a specific software, but multiple UIDs might point to the same software.
...
\textbf{talk about access to software - maybe discuss location}
