...
\katznote{as part of motivation, James added cite to his study how what people cite software.  Dan to add cite of Matthew Mayernik's similar one, and perhaps trim text/table for space.} 

Currently software appears in publications in very inconsistent ways. For example, Howison and Bullard \cite{howison2015jasist} examined a random sample of 90 articles in the biology literature and found seven different ways that software was mentioned, from simple names in the full-text, URLs in footnote, Instrument-like in-text mentions, to three different kinds of mentions in references lists: cites to project names or websites, cites to user manuals, and cites to publications that describe or introduce the software. Table \ref{tab:mentions} shows examples of these varied forms of software mentions and the frequency with which they were encountered. Even in the top journals (top 10 by impact factor), only 38\% of mentions included an entry of some sort in the reference list and fully 36\% were informal, following no recognizable style or format. Many of these kinds of mentions fail to perform the functions needed of citations, and their very diversity and frequent informality undermines the integration of software work into bibliometrics and other analyses. 

\rowcolors{2}{white}{gray!25}
\begin{table}[htbp]
\caption{Varieties of software mentions in publicatons, from  \cite{howison2015jasist}} 
\centering
\scriptsize\setlength{\tabcolsep}{2.5pt}
\begin{tabular}{@{}l l l p{0.6\textwidth}@{}}
\toprule
Mention Type & \multicolumn{2}{c}{Count (n=286)} & Example \\
\midrule
...
In some ways the situation is not too surprising: practices are diverse and informal because authors receive little guidance from editors, style guides, and their scientific communities, as well as weak support from citation software (such as Endnote and Zotero). In Howison and Bullard's study only 24\% of journals provided any guidance and software is treated inconsistently by style guides, if it appears at all.
...
A software citation should include a method for identification that is machine actionable, globally unique, interoperable, and widely used by a community.
...
Daniel S. Katz, University of Chicago \& Argonne National Laboratory (co-chair)
