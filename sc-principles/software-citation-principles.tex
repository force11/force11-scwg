...
17.\ Publish mixed data\slash software packages  & \textbullet & \textbullet & \textbullet &             & \textbullet & \textbullet & \textbullet &             & \textopenbullet & \textopenbullet & \textopenbullet & Repository \\
\bottomrule
\end{tabular}
\label{tab:use_cases}
\end{table}%
