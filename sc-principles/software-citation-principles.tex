...
plan to have a follow-on working group that will interact with stakeholders to ensure that
...
\begin{table}[htbp]
\caption{Use cases for software citation, adapted from \cite{SC-Use-Cases} \flnote{This table is a little hard to read: it is hard to follow which 'dots' belong to which lines. What about using a alternating (light) background or such to help? Also, I noticed that some entries have the same requirements: maybe they could be combined to one line?}}
\centering
