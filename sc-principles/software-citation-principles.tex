...
for software citation are of concern: \katznote{Any more items to be added to list?}
...
readable for example) this does offer a solution for authors wishing to give explicit instructions to potential citing authors.\dmnote{There is evidence from databases that people actually tend to follow such instructions if they exist: \cite{10.1371/journal.pone.0136631}.} \katznote{added this ref to the introduction - not sure if it is still needed here too}
...
and Knepley at al. do similarly~\cite{knepley2013accurately}.
