...
\begin{itemize}
\item Understanding Science: Software is a product of research, and by not citing it, we leave holes in the record of of scientific progress.
...
\item Finding Software - citations enable software to be discovered \katznote{dan to flesh out more}
\end{itemize}
