...
\S\ref{sec:futurework} we outline our future plans for discussing how these
software citation principles may be applied.
...
When software is not freely available (e.g., commercial software), alternative means may be used to create citable objects via identifiers such as RRIDs, although these topics are discussed more in \S\ref{sec:identification} and \S\ref{sec:access}.
...
limited value to potential implementers and so in addition to the principles
...
Following on from these efforts, a new Force11 working group is expected to
begin with the goal of supporting potential implementers of the software citation
principles as well as developing potential metadata standards.
