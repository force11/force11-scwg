...
The software citation principles were originally based on an adaptation of the
FORCE11 Data Citation Principles~\cite{data-citation-principles}, and
...
data. Software can be used to express or explain concepts, it is typically
updated more frequently than data\footnote{Datasets can of course be frequently
updated, but each update likely represents the findings of a new or repeated
study.}, and it is executable.
\niemnote{Dan: can you add more here?}
