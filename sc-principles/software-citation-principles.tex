...
7.\ Benchmark software                           & \textbullet & \textbullet &             &             & \textbullet & \textbullet & \textbullet &             & + & + &             & Researcher, software engineer \\
...
\niemnote{Perhaps rephrase to ``Some use cases related to citation (e.g., provenance, reproducibility) might have additional requirements beyond the basic metadata needed for citation, as Table~\ref{tab:use_cases} shows.''}
...
\item Release has all components necessary for reproducing the work (note that this ideally also means sample inputs and outputs)
\end{itemize}
