...
Inspired by the activities of the Force11 working group focussed on data citation (ref), this document summarises the recommendations of the Force11 Software Citation Working Group and their activities beween June 2015 and April 2016. Based on a review of existing community practices, the goal of the working group was to produce a consolidated set of citation principles that may encourage broad adoption of a consistent policy for software citation across disciplines and venues.

Our work is presented here as a set of software citation principles, a discussion of the motivations for developing the princples, reviews of existing community practise and a discussion of the requirements these principles would place upon different stakeholders.

Working examples and possible technical solutions for how these princples can be implemented will be disussed in a separate paper.
...
%``Researcher'' includes both academic researchers (e.g., postdoc, tenure-track
%faculty member) and research software engineers;
...
\toprule
 ...
 \cmidrule{3-11}
Stakeholder & wants to 	& \rot{Unique identifier} &  \rot{Software name} & \rot{Author(s)} & \rot{Contributor role} & \rot{Version number} & \rot{Release date} & \rot{Location\slash repository} & \rot{Indexed citations} & \rot{Software license}  \\
\midrule
Researcher            & 1.\ use someone else's software for a paper      & \textbullet & \textbullet & \textbullet &             & \textbullet & \textbullet & \textbullet &             &             \\
Researcher            & 2.\ use someone else's software for new software & \textbullet & \textbullet & \textbullet &             & \textbullet & \textbullet & \textbullet &             & \textbullet \\
Researcher            & 3.\ contribute to software                   & \textbullet & \textbullet & \textbullet & \textbullet & \textbullet & \textbullet & \textbullet &             & \textbullet \\
Researcher            & 4.\ find citations of software               & \textbullet & \textbullet &             &             &             &             &             & \textbullet &             \\
Researcher            & 5.\ get credit for software development      & \textbullet & \textbullet & \textbullet & \textbullet &             & \textbullet & \textbullet &             & \textbullet \\
Researcher            & 6.\ ``reproduce'' analysis                   & \textbullet & \textbullet &             &             & \textbullet & \textbullet & \textbullet &             & \textbullet \\
Researcher            & 7.\ benchmark software                       & \textbullet & \textbullet &             &             & \textbullet & \textbullet & \textbullet &             & \textbullet \\
Researcher            & 8.\ find software to implement task          & \textbullet & \textbullet & \textbullet &             &             &             & \textbullet & \textbullet & \textbullet \\
Publisher             & 9.\ publish software paper                   & \textbullet & \textbullet & \textbullet &             & \textbullet & \textbullet & \textbullet &             &             \\
Publisher             & 10.\ publish papers that cite software        & \textbullet & \textbullet & \textbullet &             & \textbullet & \textbullet & \textbullet & \textbullet &             \\
Indexer               & 11.\ build catalog of software                & \textbullet & \textbullet & \textbullet &             & \textbullet & \textbullet & \textbullet & \textbullet & \textbullet \\
Domain group\slash library\slash archive          & 12.\ build software catalog\slash registry                & \textbullet & \textbullet & \textbullet &             &             &             & \textbullet &             &             \\
Repository            & 13.\ show scientific impact of holdings       & \textbullet & \textbullet &             &             &             &             &             & \textbullet &             \\
Funder                & 14.\ show how funded software has been used   & \textbullet & \textbullet &             &             &             &             &             & \textbullet &             \\
Evaluator             & 15.\ evaluate contributions of researcher     & \textbullet &             & \textbullet & \textbullet &             & \textbullet &             & \textbullet &             \\
Citation manager      & 16.\ store software entry        			 & \textbullet & \textbullet & \textbullet &             & \textbullet & \textbullet & \textbullet & \textbullet &             \\
\bottomrule
\end{tabular}
\label{tab:use_cases}
\end{table}%
...
\item beginning to work on implementing some of those solutions.
  \end{enumerate*}
%\asnote{Not sure this is a sufficient one-line
%summary but couldn't think of anything better.} \katznote{I've edited it a bit}
...
publishes papers on software.} %text needs to be cleaned up LJH% dy
