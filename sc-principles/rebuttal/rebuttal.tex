...
- When we talk about a ``Unique identifier'' in the document, we're refering to unique, persistent, and machine-actionable identifiers such as a DOI, ARK, or PURL and we don't believe a repository address with a version number is sufficient.
