...
\niemnote{Dan: work on this. Bring in text from CodeMeta paper and your blog post.} \katznote{done - and see suggested response below}

We respectfully disagree with the reviewer about the value of this section. Since our work on software citation is being done following previous work on data citation (including the PeerJ CS paper on data citation (\url{https://peerj.com/articles/cs-1/}), and since our software citation principles have some difference from the data citation principles, we feel it is important to explain the high level reasons why differences might be expected.  We do agree with the reviewer's specific point about release frequency, and have added a note about this.  We have also expanded the set of differences to make the case more convincing.
...
\katznote{I've changed the text a little}
