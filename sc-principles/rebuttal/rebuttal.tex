...
\item \niemnote{Is this different than 7, ``Find software to implement task''? I suppose it's not exactly the same, and I'm fine with adding a new one to appease the reviewer}
\end{enumerate}
