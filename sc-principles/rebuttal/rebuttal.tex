...
\niemnote{how is this, including the new text?} \katznote{I've added a bit to the response, and lightly edited the text.  I also made a change in the text tied to reviewer 2 item 10 that I missed previously}
