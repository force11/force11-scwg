...
\textbf{Our response:}
We have revised the manuscript in response to both sets of issues, and hope
that these changes (in addition to the discussion here) satisfactorily resolve
