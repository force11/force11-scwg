...
\title{Lightning Talk: Software Citation: Process, Principles, and Implementation}
...
%\and
%\IEEEauthorblockN{Kyle E. Niemeyer}
%\IEEEauthorblockA{Oregon State University\\
%Corvallis, Oregon, USA\\
%Email: }
%\and
%\IEEEauthorblockN{Arfon M. Smith}
%\IEEEauthorblockA{GitHub, Inc.\\
%San Francisco, California, USA\\
%Email: }
%\and
%\IEEEauthorblockN{{FORCE11 Software Citation Working Group}}
%\IEEEauthorblockA{FORCE11}
%}
...
% 
\author{\IEEEauthorblockN{Daniel S. Katz\IEEEauthorrefmark{1},
Kyle E. Niemeyer\IEEEauthorrefmark{2},
Arfon M. Smith\IEEEauthorrefmark{3}, 
FORCE11 Software Citation Working Group\IEEEauthorrefmark{4}}
\IEEEauthorblockA{\IEEEauthorrefmark{1}University of Illinois Urbana-Champaign\\
Urbana, Illinois, USA\\
Email: d.katz@ieee.org}
\IEEEauthorblockA{\IEEEauthorrefmark{2}Oregon State University\\
Corvallis, Oregon, USA\\
Email: Kyle.Niemeyer@oregonstate.edu}
\IEEEauthorblockA{\IEEEauthorrefmark{3}GitHub, Inc.\\
San Francisco, California, USA\\
Email: arfon@github.com}
\IEEEauthorblockA{\IEEEauthorrefmark{4}FORCE11\\
\url{https://www.force11.org/group/software-citation-working-group}}}
...
The final draft paper was then submitted to  PeerJ Computer Science, published as a PeerJ preprint, and posted on the FORCE11 website \cite{bib2}. Initial review comments were returned July 8, 2016, and the working group chairs recently (August 1, 2016) submitted a revised version, and updated the PeerJ preprint \cite{bib4}. Our goal is to have a final version of the paper accepted and published by WSSSPE4.
...
\bibitem{bib2} 
A.~M.~Smith AM, D.~S.~Katz, K.~E.~Niemeyer, and FORCE11 Software Citation Working Group ``Software Citation Principles,'' FORCE2016 Website, \url{https://www.force11.org/software-citation-principles}, 2016. Accessed: 2016-07-10.
\bibitem{bib3} 
FORCE11 Software Citation Working Group, GitHub repository, \url{https://github.com/force11/force11-scwg}.  Accessed: 2016-07-10.
\bibitem{bib4} 
A.~Smith AM, D.~S.~Katz, K.~E.~Niemeyer, and FORCE11 Software Citation Working Group, “Software Citation Principles,” \textit{PeerJ Preprints} 4:e2169v2, 2106. \url{https://doi.org/10.7287/peerj.preprints.2169v3}. 
