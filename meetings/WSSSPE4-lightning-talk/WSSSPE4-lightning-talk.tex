...
The final draft paper was then submitted to  PeerJ Computer Science , published as a PeerJ preprint \cite{bib4}, and posted on the FORCE11 website \cite{bib2}. Initial review comments were provided July 8, 2016, and the working group chairs are currently discussing them. Our goal is to have a final version of the paper accepted by WSSSPE4.
...
A.~Smith AM, D.~S.~Katz, K.~E.~Niemeyer, and FORCE11 Software Citation Working Group, “Software Citation Principles,” PeerJ Preprints 4:e2169v2, 2106. \url{https://doi.org/10.7287/peerj.preprints.2169v2}. 
