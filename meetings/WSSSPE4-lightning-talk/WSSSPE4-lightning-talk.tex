...
The final draft paper was then submitted to  PeerJ Computer Science, published as a PeerJ preprint, and posted on the FORCE11 website \cite{bib2}. Initial review comments were returned July 8, 2016, and the working group chairs recently (August 1, 2016) submitted a revised version, and updated the PeerJ preprint \cite{bib4}. Our goal is to have a final version of the paper accepted by WSSSPE4.
